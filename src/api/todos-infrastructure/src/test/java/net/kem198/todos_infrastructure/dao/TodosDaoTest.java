package net.kem198.todos_infrastructure.dao;
...
public class TodosDaoTest {
    ...
    public void testCountByFinished(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/net/kem198/todos_infrastructure/dao/TodosDao/countByFinished.sql", dialect);
        execute(sqlFile);
    }
    ...
    public void testSelectAll(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/net/kem198/todos_infrastructure/dao/TodosDao/selectAll.sql", dialect);
        execute(sqlFile);
    }
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/net/kem198/todos_infrastructure/dao/TodosDao/selectById.sql", dialect);
        execute(sqlFile);
    }
